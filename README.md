# Generalized Fermat-Catalan (x^10+y^11=z^6) — Canonical Lane Mathlib

Mathlib-backed Canonical Lane formalization package for the Generalized Fermat-Catalan (x^10+y^11=z^6).

## Clean-clone replay

```bash
git clone https://github.com/HautevilleHouse/fc-x-10-y-11-z-6-mathlib.git
cd fc-x-10-y-11-z-6-mathlib
lake exe
lake build
```
